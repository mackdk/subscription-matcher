...
import com.suse.matcher.optimization.move.ConflictMatchMoveFilter;
import com.suse.matcher.optimization.move.MatchMoveIteratorFactory;
import com.suse.matcher.optimization.move.MatchSwapMoveIteratorFactory;
...
public class OptaPlanner {
    ...
    private Solver<Assignment> initSolver(boolean testing) {
        ...
        score.setScoreDrlList(List.of("com/suse/matcher/optimization/rules/Scores.drl"));
